...
- **Limited real-data prototype complete:** licensed JPPH/NAPIC historical aggregate workbooks are normalized, modelled, tested, and deployed.
...
Current data decision: five JPPH/NAPIC historical average-price workbooks were approved for this limited prototype because the government catalogue marks them Creative Commons Attribution. No clearly licensed property-level candidate passed provenance and reuse review; see `docs/REAL_DATASET_ASSESSMENT.md`.
